"""Regression checks for the quorum-lite casebook."""
...
from casebook.harness import assert_expected, quorum_lite_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(quorum_lite_summary(), assert_expected())
